...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fcgi: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fcgi ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/BlockHashAlgorithm.o: BlockHashAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BlockHashAlgorithm.o BlockHashAlgorithm.cpp
...
${OBJECTDIR}/DHashAlgorithm.o: DHashAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DHashAlgorithm.o DHashAlgorithm.cpp

${OBJECTDIR}/Gauss2DHashAlgorithm.o: Gauss2DHashAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gauss2DHashAlgorithm.o Gauss2DHashAlgorithm.cpp

${OBJECTDIR}/GaussBlockHashAlgorithm.o: GaussBlockHashAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GaussBlockHashAlgorithm.o GaussBlockHashAlgorithm.cpp

${OBJECTDIR}/GaussDHashAlgorithm.o: GaussDHashAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GaussDHashAlgorithm.o GaussDHashAlgorithm.cpp

${OBJECTDIR}/HashAlgorithmManager.o: HashAlgorithmManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HashAlgorithmManager.o HashAlgorithmManager.cpp

${OBJECTDIR}/HashManager.o: HashManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HashManager.o HashManager.cpp
...
${OBJECTDIR}/RecordManager.o: RecordManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RecordManager.o RecordManager.cpp

${OBJECTDIR}/appio.o: appio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/appio.o appio.cpp
